...
/**
 * This class provides a table model to store address book data.
 *
 * @author James Jin
...
public class AddressBookInfoDataTableModel extends AbstractTableModel {
    ...
    /**
     * a <code>List</code> object containing address book data
     */
    ...
    /**
     * Creates a new <code>AddressBookInfoDataTableModel</code> object based on
     * a <code>List</code> object.
     *
     * @param list a <code>List</code> containing the address book data
