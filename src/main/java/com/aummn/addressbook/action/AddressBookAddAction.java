...
/**
 * An <code>Action</code> object used to add an address book.
 *
 * @author James Jin
 * @version 1.0 25/07/2018
 * @since 1.0
 */
public class AddressBookAddAction extends CommandAction {

    /**
     * Creates a <code>AddressBookAddAction</code> object with specified name, image,
     ...
     */
    public AddressBookAddAction(String name, Icon image, String description,
