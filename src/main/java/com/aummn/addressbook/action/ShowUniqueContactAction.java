...
/**
 * An <code>Action</code> object used to show unique contacts in multiple address books.
 *
 * @author James Jin
 * @version 1.0 25/07/2018
 * @since 1.0
 */
public class ShowUniqueContactAction extends CommandAction {

    /**
     * Creates a <code>ShowUniqueContactAction</code> object with specified name, image,
     ...
     *
     */
    public ShowUniqueContactAction(String name, Icon image, String description,
