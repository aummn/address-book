...
/**
 * An <code>Action</code> object used to remove contacts.
 *
 * @author James Jin
 * @version 1.0 25/07/2018
 * @since 1.0
 */
public class ContactRemoveAction extends CommandAction {

    /**
     * Creates a <code>ContactRemoveAction</code> object with specified name, image,
     ...
     */
    public ContactRemoveAction(String name, Icon image, String description,
