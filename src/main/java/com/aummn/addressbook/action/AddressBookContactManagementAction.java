...
/**
 * An <code>Action</code> object helps navigate to the contact management.
 *
 * @author James Jin
 * @version 1.0 25/07/2018
 * @since 1.0
 */
public class AddressBookContactManagementAction extends CommandAction {

    /**
     * Creates a <code>AddressBookContactManagementAction</code> object with specified name, image,
     ...
     */
    public AddressBookContactManagementAction(String name, Icon image, String description,
