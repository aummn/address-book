...
/**
 * An <code>Action</code> object used to show contacts in an address book.
 *
 * @author James Jin
 * @version 1.0 25/07/2018
 * @since 1.0
 */
public class ShowContactAction extends CommandAction {

    /**
     * Creates a <code>ShowContactAction</code> object with specified name, image,
     ...
     *
     */
    public ShowContactAction(String name, Icon image, String description,
