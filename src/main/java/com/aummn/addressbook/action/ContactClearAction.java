 ...
 * @since 1.0
 */
public class ContactClearAction extends CommandAction {

    /**
     * Creates a <code>ContactClearAction</code> object with specified name, image,
     ...
     */
    public ContactClearAction(String name, Icon image, String description,
