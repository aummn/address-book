...
/**
 * An <code>Action</code> object used to add a contact.
 *
 * @author James Jin
 * @version 1.0 25/07/2018
 * @since 1.0
 */
public class ContactAddAction extends CommandAction {

    /**
     * Creates a <code>ContactAddAction</code> object with specified name, image,
     ...
     */
    public ContactAddAction(String name, Icon image, String description,
